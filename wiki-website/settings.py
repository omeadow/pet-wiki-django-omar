"""
Django settings for wiki-website project.
...
ROOT_URLCONF = 'wiki-website.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
#Templates are not getting found. adding this
...
WSGI_APPLICATION = 'wiki-website.wsgi.application'
